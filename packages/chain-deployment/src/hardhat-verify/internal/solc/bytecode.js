import {DeployedBytecodeNotFoundError} from '../errors.js'
import {
...
import {getCallProtectionOffsets, getImmutableOffsets, getLibraryOffsets} from './artifacts.js'
...
export class Bytecode {
  ...
  static async getDeployedContractBytecode(
    address,
    provider,
    network,
  ) {
